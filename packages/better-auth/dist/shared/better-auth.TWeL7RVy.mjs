...
import { z } from 'zod';
import { c as createAuthMiddleware, s as sessionMiddleware, a as createAuthEndpoint, g as getSessionFromCtx, B as BASE_ERROR_CODES, R as requestOnlySessionMiddleware } from './better-auth.BxAonGvE.mjs';
