...
const organization = require('../shared/better-auth.DR8ndJQn.cjs');
...
const admin = require('../shared/better-auth.CvtMUkbA.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.DSO5uwMP.cjs');
...
require('../shared/better-auth.DrHlxwzr.cjs');
